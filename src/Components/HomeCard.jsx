  ...
  return (
    <div className="flex flex-col lg:flex-row gap-5 lg:gap-0 justify-between items-center mb-20 lg:mb-36">
      <div data-aos="fade-up-right" className="flex flex-col gap-5 lg:w-[50%]">
        ...
        <p className="theme-text-secondary text-xl lg:text-2xl">
          I'm Mehul Arora a passionate developer from Faridabad , Currently in My First Year of B-tech . I am skilled in developing and maintaining responsive and scalable websites that enhances user experience.
        </p>
        <p className="theme-text-secondary text-xl lg:text-2xl">
      ...
      <div data-aos="fade-up-left">
        <img
          ...
          style={{ boxShadow: "0 0 40px var(--accent-glow-soft)" }}
        />
      </div>
    </div>
  );
