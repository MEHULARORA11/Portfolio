...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-8 mt-10 border-t theme-divider flex flex-col sm:flex-row items-center justify-between gap-4 text-xs tracking-wider uppercase font-semibold">
